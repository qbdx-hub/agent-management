...
export const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      // ===== 模块四：编排 =====
      {
        ...
        meta: { title: 'Agent 编排', icon: 'route' },
      },
      ...
      // ===== 模块九：安全 =====
      {
        ...
        meta: { title: '审计日志', icon: 'shield-lock' },
      },
