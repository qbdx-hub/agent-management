...
export const mockAgents: AgentSummary[] = [
  {
    ...
    avatar: '🔍', status: 'published', modelName: 'Claude Opus 4.8',
  ...
  },
  {
    ...
    avatar: '📄', status: 'published', modelName: 'GPT-4o',
  ...
  },
  {
    ...
    avatar: '📊', status: 'published', modelName: 'DeepSeek V4',
  ...
  },
  {
    ...
    avatar: '🤖', status: 'testing', modelName: 'Claude Sonnet 4.6',
  ...
  },
  {
    ...
    avatar: '🚀', status: 'paused', modelName: 'Claude Haiku 4.5',
  ...
  },
  {
    ...
    avatar: '💬', status: 'draft', modelName: 'Gemini 2.5 Flash',
...
export const mockAgentDetail: AgentDetail = {
  ...
  config: {
    ...
    boundTools: [
      ...
      { toolId: 4, toolName: 'GitHub API', toolIcon: '🐙', enabled: false },
    ],
    memory: {
      workingWindow: 20,
